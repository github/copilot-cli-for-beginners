...
Este proyecto utiliza las incidencias de GitHub para rastrear errores y solicitudes de nuevas funcionalidades. Por favor, busque las incidencias existentes antes de presentar nuevas incidencias para evitar duplicados. Para nuevas incidencias, presente su informe de error o solicitud de función como una nueva incidencia.

Para obtener ayuda o hacer preguntas sobre el uso de este proyecto, por favor abra una incidencia.
