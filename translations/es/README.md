...
description: !translate Aprende a potenciar tu flujo de trabajo de desarrollo con asistencia mediante IA en la línea de comandos desde tu terminal.
...
🎯 [Qué aprenderás](#qué-aprenderás) &ensp; ✅ [Requisitos](#requisitos) &ensp; 🤖 [Familia de Copilot](#entendiendo-la-familia-github-copilot) &ensp; 📚 [Estructura del curso](#estructura-del-curso) &ensp; 📋 [Referencia de comandos](#referencia-de-comandos-de-github-copilot-cli)

# GitHub Copilot CLI para principiantes

> **✨ Aprende a potenciar tu flujo de trabajo de desarrollo con asistencia por IA directamente en la línea de comandos.**

GitHub Copilot CLI trae asistencia de IA directamente a tu terminal. En lugar de cambiar a un navegador o editor de código, puedes hacer preguntas, generar aplicaciones completas, revisar código, generar pruebas y depurar problemas sin salir de la línea de comandos.
...
GitHub Copilot ha evolucionado a una familia de herramientas impulsadas por IA. Aquí es donde se ubica cada una:
...
| [**GitHub Copilot cloud agent**](https://docs.github.com/copilot/using-github-copilot/using-copilot-coding-agent-to-work-on-tasks) | GitHub  | Asignar issues a agentes, obtener PRs |
...
| 06 | 🔌 [Conectar a GitHub, bases de datos y APIs](./06-mcp-servers/README.md) | Integración del servidor MCP |
...
**Los ejemplos de código son ejecutables.** Cada bloque de texto de copilot en este curso se puede copiar y ejecutar en tu terminal.
...
Este proyecto está licenciado bajo los términos de la licencia de código abierto MIT. Por favor, consulta el archivo [LICENSE](../../LICENSE) para ver los términos completos.
