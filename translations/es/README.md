...
🎯 [Qué aprenderás](#qué-aprenderás) &ensp; ✅ [Requisitos](#requisitos) &ensp; 🤖 [Comprender la familia GitHub Copilot](#comprender-la-familia-github-copilot) &ensp; 📚 [Estructura del curso](#estructura-del-curso) &ensp; 📋 [Referencia de comandos](#referencia-de-comandos-del-github-copilot-cli)
