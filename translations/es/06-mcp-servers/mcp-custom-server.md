...
¿Quieres conectar Copilot a tus propias APIs? Aquí tienes cómo construir un servidor MCP simple en Python que consulta información de libros, relacionado con el proyecto de la aplicación de libros que has estado usando a lo largo de este curso.
...
1. **Agregar más herramientas** - Cada `@mcp.tool()` función se convierte en una herramienta que Copilot puede llamar
...
3. **Agregar autenticación** - Maneja las claves y tokens de API de forma segura
