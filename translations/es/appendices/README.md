...
Estos apéndices cubren temas adicionales que amplían el contenido central del curso. Son lectura opcional para cuando necesites estas capacidades específicas.

| Apéndice | Descripción | Requisito previo |
|----------|-------------|------------------|
| [Funciones adicionales de contexto](additional-context.md) | Trabajar con imágenes y permisos en varios directorios | Capítulo 02 |
