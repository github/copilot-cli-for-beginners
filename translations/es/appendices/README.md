...
title: !translate Apéndices
description: !translate Explora material de referencia opcional que amplía el curso GitHub Copilot CLI para principiantes.
...
|----------|-------------|--------------|
| [Funciones de contexto adicionales](additional-context.md) | Trabajar con imágenes y permisos en varios directorios | Capítulo 02 |
| [Integración CI/CD](ci-cd-integration.md) | Flujos de trabajo de GitHub Actions para revisiones automatizadas | Capítulo 07 |

---

**[← Volver a la página principal del curso](../README.md)**
