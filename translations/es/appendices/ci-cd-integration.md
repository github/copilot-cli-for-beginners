...
title: !translate Integración CI/CD
description: !translate Integra GitHub Copilot CLI en flujos de trabajo de GitHub Actions para revisiones automatizadas de solicitudes de extracción.
...
>
> ⚠️ **Este apéndice es para equipos con pipelines de CI/CD existentes.** Si eres nuevo en GitHub Actions o en los conceptos de CI/CD, comienza con el enfoque más simple del hook pre-commit en la sección [Automatización de revisión de código](../07-putting-it-together/README.md#workflow-3-code-review-automation-optional) del Capítulo 07.
...
5. **Manejar fallos con gracia** - No bloquees los merges por fallos en la revisión; registra y continúa
