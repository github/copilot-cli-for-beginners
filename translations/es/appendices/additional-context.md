...
description: !translate Aprende cómo usar el contexto de imágenes y gestionar permisos en múltiples directorios en GitHub Copilot CLI.
...
- **Una imagen por concepto** - funcionan varias imágenes, pero mantén el enfoque

---

## Patrones de permisos

Por defecto, Copilot puede acceder a los archivos en tu directorio actual. Para archivos en otros lugares, necesitas conceder acceso.
...
# Ahora puede hacer referencia a archivos desde ese directorio
