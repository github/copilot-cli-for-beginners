...
description: !translate Aprende a usar el contexto de imágenes y a gestionar permisos en múltiples directorios en GitHub Copilot CLI.
...
> 📖 **Requisito**: Completa [Capítulo 02: Contexto y conversaciones](../02-context-conversations/README.md) antes de leer este apéndice.
...
Las imágenes se vuelven aún más poderosas cuando se combinan con el contexto del código:
...
- **Una imagen por concepto** - múltiples imágenes funcionan, pero enfócate
...
# Ahora puedes hacer referencia a archivos en ese directorio
