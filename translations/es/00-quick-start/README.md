...
<details>
<summary>Opcional: Habilitar la autocompletación con Tab en la shell</summary>
...
<img src="../../../00-quick-start/images/copilot-trust.png" alt="Confiar en los archivos de una carpeta con Copilot CLI" width="800"/>
...
<img src="../../../00-quick-start/images/auth-device-flow.png" alt="Flujo de autorización de dispositivo - mostrando el proceso de 5 pasos desde el inicio de sesión en la terminal hasta la confirmación de sesión iniciada" width="800"/>
...
![Demostración: Hola](../../../00-quick-start/images/hello-demo.gif)
