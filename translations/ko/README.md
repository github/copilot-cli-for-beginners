...
> **✨ AI 기반 커맨드라인 어시스턴트로 개발 워크플로우를 강화하는 방법을 배웁니다.**
...
> 📘 **웹 환경을 선호하십니까?** 이 강의를 GitHub에서 바로 따라가거나, [Awesome Copilot](https://awesome-copilot.github.com/learning-hub/cli-for-beginners/)에서 더 일반적인 브라우징 환경으로 볼 수 있습니다.
...
GitHub Copilot은 AI 기반 도구의 제품군으로 발전했습니다. 각 제품이 어디에서 동작하는지 알아봅니다:
...
- 🐛 **버그를 발견했습니까?** [이슈 열기](https://github.com/github/copilot-cli-for-beginners/issues)
...
이 프로젝트는 MIT 오픈 소스 라이선스 조건에 따라 라이선스가 부여됩니다. 전체 조건은 [LICENSE](../../LICENSE) 파일을 참조합니다.
