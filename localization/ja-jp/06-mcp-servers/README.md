![第 06 章: MCP サーバー](../../../images/chapter-header.png)
...
<img src="../../../images/quick-start-mcp.png" alt="浮かぶテックアイコンに囲まれた明るい電気スパークとともに接続する電源ケーブル、MCP サーバー接続を表す" width="800"/>
...
![MCP ステータスデモ](../../../images/mcp-status-demo.gif)
...
<img src="../../../images/configuring-mcp-servers.png" alt="MCP サーバーの設定を表すプロフェッショナルなオーディオミキシングボードのノブとスライダーを調整する手" width="800"/>
...
| オプションの追加機能（カスタムサーバー、web_fetch）を探る | [基本を超えて](#beyond-the-basics) |
...
<img src="../../../images/using-mcp-servers.png" alt="MCP サーバーを使う - GitHub、Filesystem、Context7、カスタム/Web Fetch サーバーに接続された開発者 CLI を示すハブアンドスポーク図" width="800" />
...
**Microsoft Learn MCP**: [Microsoft Learn MCP サーバー](#microsoft-learn-mcp-server)をインストールした場合、公式 Microsoft ドキュメントを直接検索できます。
...
<img src="../../../images/issue-to-pr-workflow.png" alt="MCP を使った issue から PR へのワークフロー - GitHub イシューの取得からプルリクエスト作成までの完全なフローを示す" width="800"/>
...
![MCP ワークフローデモ](../../../images/mcp-workflow-demo.gif)
...
> 💡 **filesystem MCP をまだ設定していませんか？** 上記の[完全な設定](#complete-configuration-file)セクションから設定ファイルを作成してください。そして Copilot を再起動します。
...
上記の[完全な設定](#complete-configuration-file)セクションの JSON を使って `~/.copilot/mcp-config.json` として保存します。
