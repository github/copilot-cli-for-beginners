...
> 📖 **Requisito previo**: Completa el [Capítulo 07: Poniéndolo todo junto](../07-putting-it-together/README.md) antes de leer este apéndice.
>
> ⚠️ **Este apéndice es para equipos con pipelines de CI/CD existentes.** Si eres nuevo en GitHub Actions o en los conceptos de CI/CD, comienza con el enfoque más simple de pre-commit hooks en la sección [Automatización de revisión de código](../07-putting-it-together/README.md#workflow-3-code-review-automation-optional) del Capítulo 07.

Este apéndice muestra cómo integrar GitHub Copilot CLI en tus pipelines de CI/CD para la revisión automatizada de código en pull requests.
...
Puedes enfocar la revisión en tipos específicos de problemas:
...
## Alternativa: Bot de revisión de PRs

Para flujos de trabajo de revisión más sofisticados, considera usar el agente cloud de GitHub Copilot:
...
1. **Usa el flag `--silent`**: Suprime la salida de progreso para logs más limpios
2. **Establece tiempos de espera (timeouts)**: Evita que revisiones colgadas bloqueen tu pipeline
3. **Filtra tipos de archivos**: Revisa solo los archivos relevantes (omite código generado y dependencias)
4. **Ten en cuenta los límites de velocidad (rate limits)**: Espacia las revisiones para PRs grandes
5. **Falla de forma elegante**: No bloquees las fusiones por fallos en la revisión; registra y continúa
...
Asegúrate de que tu flujo de trabajo tiene los permisos correctos:
...
### Las revisiones se agota el tiempo de espera

Aumenta el timeout o reduce el alcance:
